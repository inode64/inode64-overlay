...
# tar --create --auto-compress --file guacamole-client-1.6.0-node_modules.tar.xz \
#	guacamole-client-1.6.0/guacamole/src/main/frontend/node_modules guacamole-client-1.6.0/guacamole-common-js/node
