...
inherit autotools elisp-common python-single-r1 tmpfiles systemd shell-completion

DESCRIPTION="GlusterFS is a powerful network/cluster filesystem"
HOMEPAGE="https://www.gluster.org/ https://github.com/gluster/glusterfs/"
SRC_URI="https://github.com/gluster/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz"
...
src_prepare() {
	...
	# Fix /var/run -> /run migration
	sed -i -e 's:@localstatedir@/run:/run:g' events/src/*.in extras/ocf/*.in extras/systemd/*.in tests/*.in || die
