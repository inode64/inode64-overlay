...
EGIT_COMMIT="64ebf2eede125ca175021f31f8d01f8846809d29"
...
PATCHES=(
	...
	"${FILESDIR}"/imap-fix-autofoo.patch
	"${FILESDIR}"/php-7.4.11-fix-phpize-for-parallel-installation.patch
	...
	"${FILESDIR}"/strcasestr-crosscompile.patch
	"${FILESDIR}"/php-7.4.0-httpd.patch
	"${FILESDIR}"/php-7.2.0-includedir.patch
	"${FILESDIR}"/php-7.4.0-embed.patch
	"${FILESDIR}"/php-7.2.0-libdb.patch
	"${FILESDIR}"/php-7.0.7-curl.patch
	"${FILESDIR}"/php-net-snmp.patch
	"${FILESDIR}"/php-7.3.3-systzdata-v19.patch
	"${FILESDIR}"/php-7.4.0-phpize.patch
	"${FILESDIR}"/php-7.4.0-ldap_r.patch
	"${FILESDIR}"/php-7.4.20-argon2.patch
	"${FILESDIR}"/php-7.4.8-phpinfo.patch
	"${FILESDIR}"/php-7.0.10-datetests.patch
	"${FILESDIR}"/php-7.4.11-PHP_CHECK_FUNC_LIB-no-run.patch
	"${FILESDIR}"/php-7.4.11-reproducible-build.patch
	"${FILESDIR}"/php-7.4.33-zlib-tests.patch
)
php_install_ini() {
	local phpsapi="${1}"
