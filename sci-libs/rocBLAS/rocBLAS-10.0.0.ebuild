...
S="${WORKDIR}/rocm-libraries-${ROCM_LIBRARIES_COMMIT}/projects/rocblas"
LICENSE="MIT BSD"
SLOT="0/$(ver_cut 1-2)"
SLOT_NOLIVE=${SLOT}
...
src_unpack() {
	...
	local sources=(
		"rocm-libraries-${ROCM_LIBRARIES_COMMIT}/projects/rocblas"
		"rocm-libraries-${ROCM_LIBRARIES_COMMIT}/shared/tensile"
	)
	tar -xzf "${DISTDIR}/${archive}" -C "${WORKDIR}" "${sources[@]}" || die
}
